...
5. dotnet run --project LoadOfEducationalPrograms [X-CN-UUID] [OrganizationId] "[Шаблон образовательной программы.xlsx]" [url to api of online.edu.ru]
6. dotnet run --project LoadOfStudyPlans [X-CN-UUID] [OrganizationId] "[Шаблон учебного плана.xlsx]" [url to api of online.edu.ru]